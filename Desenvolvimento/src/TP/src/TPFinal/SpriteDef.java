...
public class SpriteDef {
	...
	public void show() {
		...
		//este index e calculado com o index anterior e o tamanho total de frames na sprite. � aumentando com base no speed dado para nao haver aquele efeito de patinhar que alguns jogos t�m
		//quando uso esse index para desenhar a imagem, faco o floor para eliminar a parte decimal, pois o array so tem posi��es inteiras e se o meu cavalo tiver speed de 0.3 significa que 
