...
public class T1_31 implements InterfaceProcessingApp {
	...
	public void draw(PApplet p, float dt) {
		...
		if (p.keyPressed) {
			// faser reset ao logo em termos de cor e posi��o. mudar o background para
			// branco
			if (p.key == 'c')
				mouseX = 400;
			mouseY = 300;
	...
	public void kitKat(PApplet p, float oX, float oY) {
		// PS:NAO VOLTES A FAZER UMA COISA ASSIM ! ISTO E MUITA FRUTA !! ja estas a
		// fazer isto a 4 horas....
