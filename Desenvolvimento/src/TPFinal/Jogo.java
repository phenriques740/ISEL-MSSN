...
public class Jogo implements InterfaceProcessingApp {
	...
	public void setup(PApplet p) {
		...
		// para o personagem principal: (fazer load da primeira anima��o.
	...
	public void draw(PApplet p, float dt) {
		...
		if (!bones.isEmpty()) {
			// System.out.println("bones n�o esta empty!");
			for (SpriteDef bone : bones) {
				bone.show();
				bone.animateVertical();
				// bone.setSpeedUpFactor(bone.getSpeedUpFactor()); // de forma a andar para tr�s
			}
		}
	...
	public void loadRunRightAnimation(PApplet p) {
		...
		// este IF e para saber se ja estou a andar na dire��o certa ou se preciso de
		// inverter !
