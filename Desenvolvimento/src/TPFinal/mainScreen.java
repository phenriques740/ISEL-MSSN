...
public class mainScreen {
	...
	private void tipsMenu() {
		...
		drawText("Quando os inimigos s�o destruidos, existe uma chance de cair um powerup", 30, 30 );
		...
		drawText("Bot�o Esquerdo do Rato serve para Disparar.", 200, 500 );
	...
	public void drawGameOverText(String string, int textX, int textY) {
		//diferente do outro m�todo por causa do tamanho e a cor da letra!
		p.textSize(100);
		p.fill(255,0,0);
