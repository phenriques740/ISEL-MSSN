...
public class SubPlot {
	...
	/**
	 * Cria um subplot dentro de uma PApplet
	 * 
	 * 
	 * @param window
	 * @param viewport
	...
	/**
	 * Devolve a localizacao absoluta em pixeis de um objeto tendo em conta
	 * coordenadas relativas dentro do subplot.
	 * 
	 * @param x
	 * @param y
	 * @return float[] Coordenadas em pixeis
	 */
